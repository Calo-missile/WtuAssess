package com.hsc.wtuassess.util.banner;
...
public class BannerView extends LinearLayout {
    ...
    public void setImageResources(ArrayList<Object> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(R.drawable.point_enable);
            } else {
                lp.leftMargin = imagePadding;
                mImageViews[i].setBackgroundResource(R.drawable.point_disable);
            }
